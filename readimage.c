...
void print_bitmap(char * bits, int size);
void print_inode(struct ext2_inode *inode_table, int inum);
void print_inodes(struct ext2_inode *inode_table, char* inode_bitmap, int size);
void print_directory_block(struct ext2_inode *inode_table, int inum, char* disk);
void print_directory_blocks(struct ext2_inode *inode_table, char* inode_bitmap, int size, char* disk);
...
int main(int argc, char **argv) {
    ...
    print_group(sb, gd);
    char * block_bitmap = disk + (gd->bg_block_bitmap * EXT2_BLOCK_SIZE);
    char * inode_bitmap = disk + (gd->bg_inode_bitmap * EXT2_BLOCK_SIZE);
    printf("Block bitmap: ");
    print_bitmap(block_bitmap, sb->s_blocks_count / 8);
    printf("Inode bitmap: ");
    print_bitmap(inode_bitmap, sb->s_inodes_count / 8);
    printf("\n");
    print_inodes(inode_table, inode_bitmap , sb->s_inodes_count);
